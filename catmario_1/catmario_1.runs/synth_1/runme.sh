...
HD_PWD='E:/a_summer_xilinx/catmario_1/catmario_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_display.tcl
