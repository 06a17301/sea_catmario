...
HD_PWD='E:/a_summer_xilinx/catmario_1/catmario_1.runs/monsterg_dist_mem_gen_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log monsterg_dist_mem_gen_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source monsterg_dist_mem_gen_0.tcl
