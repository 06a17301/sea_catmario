...
#
# Generated by export_simulation on Thu Jul 30 13:05:04 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './hidden_dist_mem_gen_0.sh' script.

./hidden_dist_mem_gen_0.sh -reset_run
...
./hidden_dist_mem_gen_0.sh -noclean_files

For more information on the script, please type './hidden_dist_mem_gen_0.sh -help'.
