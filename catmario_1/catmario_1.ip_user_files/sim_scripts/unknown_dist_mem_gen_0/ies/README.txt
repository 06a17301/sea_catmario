...
#
# Generated by export_simulation on Wed Jul 29 10:35:13 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './unknown_dist_mem_gen_0.sh' script.

./unknown_dist_mem_gen_0.sh -reset_run
...
./unknown_dist_mem_gen_0.sh -noclean_files

For more information on the script, please type './unknown_dist_mem_gen_0.sh -help'.
