...
#
# Generated by export_simulation on Sat Aug 01 10:05:47 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './monsterb_dist_mem_gen_0.sh' script.

./monsterb_dist_mem_gen_0.sh -reset_run
...
./monsterb_dist_mem_gen_0.sh -noclean_files

For more information on the script, please type './monsterb_dist_mem_gen_0.sh -help'.
