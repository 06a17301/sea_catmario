...
#
# Generated by export_simulation on Thu Jul 30 13:07:48 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './fail_dist_mem_gen_0.sh' script.

./fail_dist_mem_gen_0.sh -reset_run
...
./fail_dist_mem_gen_0.sh -noclean_files

For more information on the script, please type './fail_dist_mem_gen_0.sh -help'.
