...
#
# Generated by export_simulation on Wed Jul 29 10:39:02 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './catg_dist_mem_gen_0.sh' script.

./catg_dist_mem_gen_0.sh -reset_run
...
./catg_dist_mem_gen_0.sh -noclean_files

For more information on the script, please type './catg_dist_mem_gen_0.sh -help'.
