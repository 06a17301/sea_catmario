...
#
# Generated by export_simulation on Thu Jul 30 13:06:28 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './win_dist_mem_gen_0.sh' script.

./win_dist_mem_gen_0.sh -reset_run
...
./win_dist_mem_gen_0.sh -noclean_files

For more information on the script, please type './win_dist_mem_gen_0.sh -help'.
