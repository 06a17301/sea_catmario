...
#
# Generated by export_simulation on Sat Aug 01 10:03:50 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './monsterr_dist_mem_gen_0.sh' script.

./monsterr_dist_mem_gen_0.sh -reset_run
...
./monsterr_dist_mem_gen_0.sh -noclean_files

For more information on the script, please type './monsterr_dist_mem_gen_0.sh -help'.
