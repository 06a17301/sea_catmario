...
#
# Generated by export_simulation on Sat Aug 01 10:05:14 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './monsterg_dist_mem_gen_0.sh' script.

./monsterg_dist_mem_gen_0.sh -reset_run
...
./monsterg_dist_mem_gen_0.sh -noclean_files

For more information on the script, please type './monsterg_dist_mem_gen_0.sh -help'.
