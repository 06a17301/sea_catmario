...
#
# Generated by export_simulation on Wed Jul 29 10:59:37 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './brick_dist_mem_gen_0.sh' script.

./brick_dist_mem_gen_0.sh -reset_run
...
./brick_dist_mem_gen_0.sh -noclean_files

For more information on the script, please type './brick_dist_mem_gen_0.sh -help'.
