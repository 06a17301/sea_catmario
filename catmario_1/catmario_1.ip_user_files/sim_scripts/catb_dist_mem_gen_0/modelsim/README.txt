...
#
# Generated by export_simulation on Wed Jul 29 10:40:08 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './catb_dist_mem_gen_0.sh' script.

./catb_dist_mem_gen_0.sh -reset_run
...
./catb_dist_mem_gen_0.sh -noclean_files

For more information on the script, please type './catb_dist_mem_gen_0.sh -help'.
