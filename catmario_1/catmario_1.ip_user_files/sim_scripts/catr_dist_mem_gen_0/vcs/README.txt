...
#
# Generated by export_simulation on Wed Jul 29 10:38:03 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './catr_dist_mem_gen_0.sh' script.

./catr_dist_mem_gen_0.sh -reset_run
...
./catr_dist_mem_gen_0.sh -noclean_files

For more information on the script, please type './catr_dist_mem_gen_0.sh -help'.
